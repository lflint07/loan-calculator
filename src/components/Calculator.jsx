...
function Calculator() {
  ...
  //state to storage the results of the calcuation
  ...
  const isValid = () => {
    ...
    if (isNaN(amount) || isNaN(interest) || isNaN(years)) {
      actualError = "All the values must be a number";
    }
  ...
  //Handle the data submitted - validate inputs and send it as a parameter to the function that calculates the loan
          ...
          {!results.isResult ? (
            ...
            <div className="form-items">
              <h4>
                ...
                Interest: {userValues.interest}% <br /> Years to repay:{" "}
                {userValues.years}
              </h4>
              <div>
